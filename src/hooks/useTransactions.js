...
// Owns the transactions list plus the offline write queue: loads from
// Supabase (falling back to the last cached snapshot when offline), queues
// creates/deletes made while offline or mid-network-failure, and flushes
// that queue against Supabase once back online.
